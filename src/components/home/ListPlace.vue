...
<v-container v-else grid-list-xl>
      ...
      ></v-divider>
        ...
        name="PetHotel"
        text
        @click="postType">Pet Hotel</v-btn>
      ...
      ></v-divider>
        ...
        name="PetHospital" 
        text
        @click="postType">Pet Hospital</v-btn>
      ...
      ></v-divider>
        ...
        name="PetGrooming" 
        text
        @click="postType">Pet Grooming</v-btn>
      ...
      ></v-divider>
        ...
        name="PetRestaurant" 
        text
        @click="postType">Restaurant <br>( Pet Allowed )</v-btn>
      </div> 
    </v-col>
  </v-row>
</v-card>
    ...
    <template v-slot:default="{ hover }">
      ...
      >
          <v-rating
            ...
            size="14"
          ></v-rating>
          <div class="grey--text ml-4">({{item.placesRating}})</div>
          </v-row>
        </v-card-text>
          ...
          >
            <v-btn 
            @click="placeDetails(item.ID)">See more info</v-btn>
...
export default {
  ...
  mounted () {
   ...
   coords => 
      axios
    .get('https://skilled-array-252503.appspot.com/placesdist/?&lat='+ coords.latitude + '&long=' + coords.longitude)
    .then(response => {
